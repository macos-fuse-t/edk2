...
################################################################################
[Defines]
  PLATFORM_NAME                  = ArmVirtScorpi
  PLATFORM_GUID                  = DFFED32B-DFFE-D32B-DFFE-D32BDFFED32B
  PLATFORM_VERSION               = 0.1
  DSC_SPECIFICATION              = 0x00010005
  OUTPUT_DIRECTORY               = Build/ArmVirtScorpi-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64|ARM
  BUILD_TARGETS                  = DEBUG|RELEASE|NOOPT
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = ArmVirtPkg/ArmVirtScorpi.fdf
...
!endif
  ...
  PlatformBootManagerLib|ArmVirtPkg/Library/ScorpiPlatformBootManagerLib/ScorpiPlatformBootManagerLib.inf
...
[LibraryClasses.common.PEIM]
  ArmVirtMemInfoLib|ArmVirtPkg/Library/ScorpiVirtMemInfoLib/ScorpiMemInfoPeiLib.inf
!if $(TPM2_ENABLE) == TRUE
...
!endif
  gArmPlatformTokenSpaceGuid.PcdCPUCoresStackBase|0x10007c000
...
!if $(SECURE_BOOT_ENABLE) == TRUE
  ArmVirtPkg/ScorpiSecurityStubDxe/ScorpiSecurityStubDxe.inf {
    <LibraryClasses>
!if $(TPM2_ENABLE) == TRUE
...
!endif
  ...
  # Platform Driver
  #
  ArmVirtPkg/ScorpiPlatformDxe/ScorpiPlatformDxe.inf {
    <LibraryClasses>
    NULL|ArmVirtPkg/Library/NorFlashKvmtoolLib/NorFlashKvmtoolLib.inf
  }
