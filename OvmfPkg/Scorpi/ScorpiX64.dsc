...
################################################################################
[Defines]
  PLATFORM_NAME                  = ScorpiX64
  PLATFORM_GUID                  = 5007a7db-becc-4776-b6e6-ec653c586222
  PLATFORM_VERSION               = 0.1
  DSC_SPECIFICATION              = 0x00010005
  OUTPUT_DIRECTORY               = Build/ScorpiX64
  SUPPORTED_ARCHITECTURES        = X64
  BUILD_TARGETS                  = NOOPT|DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = OvmfPkg/Scorpi/ScorpiX64.fdf
...
[LibraryClasses]
  ...
  VirtNorFlashPlatformLib|OvmfPkg/Scorpi/Library/ScorpiVirtNorFlashPlatformLib/ScorpiVirtNorFlashPlatformLib.inf
...
[LibraryClasses.common.DXE_RUNTIME_DRIVER]
  PcdLib|MdePkg/Library/DxePcdLib/DxePcdLib.inf
  TimerLib|UefiCpuPkg/Library/CpuTimerLib/BaseCpuTimerLib.inf
  ResetSystemLib|OvmfPkg/Scorpi/Library/ScorpiResetSystemLib/ScorpiResetSystemLib.inf
...
!else
  DebugLib|OvmfPkg/Library/PlatformDebugLibIoPort/PlatformDebugLibIoPort.inf
!endif
  PlatformBootManagerLib|OvmfPkg/Scorpi/Library/ScorpiPlatformBootManagerLib/ScorpiPlatformBootManagerLib.inf
...
!endif
  ...
  gEfiMdeModulePkgTokenSpaceGuid.PcdPciSerialParameters|{0x0F, 0x1D, 0x50, 0x82, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF}

  gEfiMdePkgTokenSpaceGuid.PcdReportStatusCodePropertyMask|0x07

  # KVM APs begin in wait-for-INIT state, so use the full INIT-SIPI-SIPI
  # sequence for the first MpInitLib wakeup.
...
[Components]
  ...
  OvmfPkg/Scorpi/ScorpiPlatformPei/ScorpiPlatformPei.inf
...
!include OvmfPkg/Include/Dsc/OvmfTpmSecurityStub.dsc.inc
  ...
  MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridgeDxe.inf {
    <LibraryClasses>
      PciHostBridgeLib|OvmfPkg/Scorpi/Library/ScorpiPciHostBridgeLib/ScorpiPciHostBridgeLib.inf
  ...
  #
  # USB controller and HID support.
  #
...
!if $(SECURE_BOOT_ENABLE) == TRUE
  ...
  OvmfPkg/Scorpi/ScorpiSecureBootEnrollDxe/ScorpiSecureBootEnrollDxe.inf
!endif
...
!else
  ...
  MdeModulePkg/Universal/FaultTolerantWriteDxe/FaultTolerantWriteDxe.inf {
    <LibraryClasses>
      NULL|OvmfPkg/Scorpi/Library/ScorpiVirtNorFlashPlatformLib/ScorpiVirtNorFlashPlatformLib.inf
  }
